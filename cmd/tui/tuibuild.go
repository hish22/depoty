...
func TuiStart() {
	...
	InstallConfModal := OperationOnPackage("Are you sure you want to install this package?", installation.InstallPkg, app, foundPkgsTable, packageTable, rowFlex)

	// Handle the installation button & press (To Trigger the process of installation)
	TriggerOperationProcess(tcell.KeyCtrlD, app, foundPkgsTable, InstallConfModal)

	// Create Confirmation box & Handle the updation process
	// UpdateconfModal := OperationOnPackage("Are you sure you want to Update this package?",)
